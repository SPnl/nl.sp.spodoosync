...
class CRM_Spodoosync_RetourPost {
    ...
    protected function __construct() {
        try {
            ...
            $this->migratie_field = civicrm_api3('CustomField', 'getsingle', array('custom_group_id' => $this->migratie_set['id'], 'name' => 'Retourpost'));
        } catch (Exception $e) {
            //do nothing
        }
    }
    ...
    public static function syncRetourPostToOdoo($contact_id, &$parameters) {
        ...
        try {
            ...
            $parameters['opt_out'] = new xmlrpcval($retourPost, 'bool');
        } catch (Exception $e) {
            return;
        }
    }
